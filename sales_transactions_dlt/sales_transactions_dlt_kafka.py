...
spark.conf.set("spark.sql.legacy.timeParserPolicy", "LEGACY") # Alterando a politica de parsing de datas para o modo antigo, o dataset contém datas com o formato antigo.
